...
public class ManejadorCategorias extends Conexion{
    ...
    /* Realiza una petición a la base de datos y devuelve una colección de categorías, si el valor del parametro 
       ...
       propiedad “productos” de cada categoría será NULL */
        public static List<Categoria> obtener(boolean producto) throws ErrorAplicacion, Exception{
    ...
    public static void actualizar(Categoria c) throws ErrorAplicacion, Exception{
  
        if (c.nombre.isEmpty() || c.idCategoria < 0 || c.nombre == " " || c.nombre == null) {
    ...
    public static void insertar(Categoria c) throws ErrorAplicacion, Exception{
    ...
    public static void eliminar(Categoria c)throws ErrorAplicacion, Exception{
