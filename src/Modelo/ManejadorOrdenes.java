...
public class ManejadorOrdenes {
    ...
    /* va a la base de datos y filtra todas las ordenes cuyo campo Activa=TRUE, y devuelve un colección de 
       objetos Orden */
    public static List<Orden> ordenesActivas()throws ErrorAplicacion, Exception{
    ...
    public static Orden Obtener(Integer idOrden)throws ErrorAplicacion, Exception{
        Conexion cn = new Conexion();
        ResultSet rs = null;
        Orden o = new Orden();
        try {
    ...
    public static void actualizar(Orden o)throws ErrorAplicacion, Exception{
        if(o.detalle.size() > 0){
            o.calcularTotal();
            if(o.total > 0){
                Conexion cn = new Conexion();
    ...
    public static List<Orden> buscarActivas(String cadena)throws ErrorAplicacion, Exception{
        Conexion cn = new Conexion();
        ResultSet rs = null;
        List<Orden> ordenes = new ArrayList<>();
        try {
    ...
    public static void insertar(Orden o)throws ErrorAplicacion, Exception{
        Conexion cn = new Conexion();
    ...
    public static void eliminar(Orden o)throws ErrorAplicacion, Exception{
        Conexion cn = new Conexion();
        cn.UID("DELETE FROM DetalleOrden WHERE idOrden = '"+o.idOrden+"'");
    ...
    public static List<Orden> obtenerVentas(Date fecha)throws ErrorAplicacion, Exception{
        Conexion cn = new Conexion();
        ResultSet rs = null;
        List<Orden> ordenes = new ArrayList<>();
        try {
    ...
    public static List<Orden> obtenerVentas(Date fechaDesde, Date fechaHasta)throws ErrorAplicacion, Exception{
        Conexion cn = new Conexion();
        ResultSet rs = null;
        List<Orden> ordenes = new ArrayList<>();
        try {
